...
area1_pointA = (2, 590)
area1_pointB = (600, 590)
area1_pointC = (0, 600)
area1_pointD = (600, 600)

'''area2_pointA = (210, 100)
area2_pointB = (1300, 100)
area2_pointC = (165, 110)
area2_pointD = (1300, 110)'''
...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            ''' cv2.line(im0, area2_pointA, area2_pointB, (255, 0, 0), 2) #new line 
            cv2.line(im0, area2_pointC, area2_pointD, (255, 0, 0), 2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='nightexample.mp4', help='source')  # file/folder, 0 for webcam
    ...
    opt = parser.parse_args()#GIVING PRIORITY TO THE CROWDED ROUTE
